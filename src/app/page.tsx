...
export default function Home() {
  ...
  const projects = [
    {
      id: '01',
      title: 'NemoClaw Agent Watchdog & Security Sandbox',
      category: 'Autonomous Agent Telemetry & Sandbox Isolation',
      desc: 'A zero-dependency health watchdog, incident logging daemon, and Landlock/Capsh container security sandbox for multi-agent LLM runtimes (OpenClaw, Hermes). Monitors container process health and dispatches instant telemetry to Discord and ntfy.sh.',
      tech: ['Python 3.13', 'Docker', 'OpenShell', 'Systemd', 'Bash'],
      demoUrl: 'https://github.com/AnthonyASBaptiste/nemoclaw-agent-watchdog',
      badge: 'FLAGSHIP AGENT SYSTEM',
      starred: true,
      metrics: 'Landlock/Capsh Isolation • Instant Telemetry',
    },
    {
      id: '02',
      title: 'OnboardBob',
      category: 'Autonomous Repo Cartographer & Onboarding Copilot',
      desc: 'An autonomous codebase topology cartographer and onboarding copilot built with 3 parallel subagents (Env Auditor, Repo Mapper, Runtime Checker). Features a 3-layer prompt injection defense against poisoned repositories.',
      tech: ['Node.js', 'TypeScript', 'AST Parsing', 'Subagent Orchestration'],
      demoUrl: 'https://github.com/AnthonyASBaptiste/onboardbob',
      badge: 'IBM DEV DAY SUBMISSION',
      starred: true,
      metrics: '3-Layer Prompt Defense • Parallel Subagents',
    },
    {
      id: '03',
      title: 'Research Navigator',
      category: 'AI Multi-Agent Architectural Case Study',
      desc: 'High-level system design case study of an automated validation platform. Orchestrates a high-performance Go WebSocket proxy runtime, Python LLM-as-a-Judge audit engine, and dynamic user dashboard.',
      tech: ['Go Proxy', 'Python LLM Engine', 'Vue 3', 'WebSockets'],
